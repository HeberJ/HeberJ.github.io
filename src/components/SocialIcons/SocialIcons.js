...
const SocialIcons = (props, context) => {
  ...
  return (
    <div className="social-icons animate-icons">
      <a target="_blank" rel="noopener noreferrer" href="https://github.com/HeberJ" style={{ color: colorPrimary }}><i className="fab fa-github"></i></a>
      <a target="_blank" rel="noopener noreferrer" href="https://stackoverflow.com/users/6905065/heeb" style={{ color: colorPrimary }}><i className="fab fa-stack-overflow"></i></a>
      <a target="_blank" rel="noopener noreferrer" href="" style={{ color: colorPrimary }}><i className="fab fa-linkedin"></i></a>

      <a className="devto" target="_blank" rel="noopener noreferrer" href="">
